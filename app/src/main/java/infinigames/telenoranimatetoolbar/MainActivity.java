package infinigames.telenoranimatetoolbar;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toggleButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (on) {
                    animateAppAndStatusBar(R.color.primary_text_dark_background, R.color.primary);
                    mToolbar.setTitleTextColor(getResources().getColor(R.color.primary_text_dark_background));
                } else {
                    animateAppAndStatusBar(R.color.primary, R.color.primary_text_dark_background);
    ...
    private void animateAppAndStatusBar(int fromColor, final int toColor) {
        Animator animator = ViewAnimationUtils.createCircularReveal(
                ...
                mToolbar.getWidth() + mToolbar.getHeight(), mToolbar.getWidth(),
                mToolbar.getWidth() * 2);
